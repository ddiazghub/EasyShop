...
const orderHistoryButton = document.getElementById("order-history-btn")! as HTMLAnchorElement;
const receivedHistoryButton = document.getElementById("received-history-btn")! as HTMLAnchorElement;
const logoutButton = document.getElementById("logout-btn") as HTMLAnchorElement;
const userStoreButton = document.getElementById("user-store-btn")! as HTMLAnchorElement;
